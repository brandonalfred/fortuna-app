	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent
				...
				className="fixed inset-0 flex h-dvh w-dvw max-w-none sm:max-w-none translate-x-0 translate-y-0 top-0 left-0 items-center justify-center overflow-visible border-none bg-black/90 p-0 rounded-none shadow-none data-[state=open]:zoom-in-100 data-[state=closed]:zoom-out-100"
			>
